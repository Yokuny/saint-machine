...
function LinkContent(){
    ...
    return(
        ...
        <div className="flex justify-center mt-6">
            <button onClick={previousPage} className="mx-2 px-4 p-1 border text-xs xl:text-sm text-fuchsia-300 border-fuchsia-300 hover:text-gray-900 hover:bg-fuchsia-300 duration-500">{backwardWords}</button>
            <button onClick={nextPage} className="mx-2 px-4 p-1 border text-xs xl:text-sm text-fuchsia-300 border-fuchsia-300 hover:text-gray-900 hover:bg-fuchsia-300 duration-500">{fowardWords}</button>
        </div>
        </>
    )
}
